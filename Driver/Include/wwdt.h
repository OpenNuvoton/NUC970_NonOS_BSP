 ...
 * @version  V1.00
 * $Revision: 2 $
 * $Date: 15/05/18 10:34a $
 * @brief    NUC970 WWDT driver header file
 *
 * @note
...
/** @addtogroup NUC970_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC970_WWDT_EXPORTED_CONSTANTS */
