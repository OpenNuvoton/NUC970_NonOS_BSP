...
/** @addtogroup NUC970_USBH_Driver USB Host Driver
  @{
*/
...
/** @addtogroup NUC970_USBH_EXPORTED_TYPEDEFS USB Host Exported Type Define
  @{
*/
struct usbhid_dev;
...
/*@}*/ /* end of group NUC970_USBH_EXPORTED_TYPEDEFS */



/** @addtogroup NUC970_USBH_EXPORTED_FUNCTIONS USBH Host Exported Functions
  @{
*/
...
extern int usbh_uvc_is_device_found(void);
extern int usbh_uvc_open(int req_format);
extern int usbh_uvc_set_format(int width, int height, int req_format);
extern int usbh_uvc_set_frame_rate(int n);
extern int usbh_uvc_start_video_streaming(void);
extern int usbh_uvc_stop_video_streaming(void);
extern int usbh_uvc_query_image(uint8_t **image_buf, int *image_len, int *handle);
extern void usbh_uvc_release_image(int handle);
...
/*@}*/ /* end of group NUC970_USBH_Driver */
